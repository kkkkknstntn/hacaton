...
const VkIdButton: React.FC<VkIdButtonProps> = ({ onClick }) => {
  return (
    <button
    ...
    >
      <div className={style.VkIdWebSdk__button_container}>
        <div className={style.VkIdWebSdk__button_icon}>
          <svg
            width="28"
            height="28"
            viewBox="0 0 28 28"
        ...
        <div className={style.VkIdWebSdk__button_text}>Войти с VK ID</div>
      </div>
    </button>
  );
};
